  ...
  const achievements = [
    {
      ...
      description:
        "Mentored over 100 students in full-stack development and design",
    },
    {
      icon: Code,
      title: "Full-Stack Developer",
      description:
        "Expert in modern web technologies and development practices",
    },
    {
      icon: Palette,
    ...
    },
    {
      ...
      description: "Specialized in open-source intelligence and cybersecurity",
    },
  ];
  ...
  const experience = [
    {
      ...
      description:
        "Teaching modern web development while building production applications",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Conducting investigations using open-source intelligence techniques",
      highlights: [
        "Digital forensics",
        "Data analysis",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              Passionate full-stack developer and educator with expertise in
              modern web technologies, design, and cybersecurity. I've taught
              over <strong>100+ students</strong> and built countless
              applications using cutting-edge technologies and AI tools.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              I combine technical expertise with creative design and
              investigative skills to solve complex problems
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive knowledge across the full development stack and
              modern design tools
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              I believe in learning by building. My approach combines
              theoretical knowledge with hands-on projects, ensuring students
              not only understand concepts but can apply them in real-world
              scenarios. With over 50+ students mentored, I've seen the power of
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Tailored guidance for each student
                </p>
              </div>
              <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 sm:p-12 text-center text-white">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Whether you need development help, design consultation, or want to
              learn new technologies, I'm here to help you achieve your goals.
            </p>
